(() => {
  ...
  style.textContent = `
    ...
    @media(max-width:620px){.ai-wallet-pill{top:auto;bottom:14px;right:12px}.ai-wallet-modal{top:auto;bottom:10px;right:12px;max-height:82vh}.ai-wallet-backdrop{backdrop-filter:blur(3px)}}
  `;
