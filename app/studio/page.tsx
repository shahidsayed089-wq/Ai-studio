...
export default function WorkflowStudio() {
  ...
  const bootstrap = useCallback(async () => {
    ...
    try {
      ...
      if (!session.authenticated) { window.location.href = "/?auth=login&next=/studio"; return; }
  ...
  if (loading) return <main className="studio-loading"><span className="studio-spinner" /><h1>Opening SHAZAN AI Workflow Studio</h1><p>Restoring projects, queue and credits…</p></main>;

  return (
    <main className="studio-shell">
      <header className="studio-topbar">
        <Link className="studio-brand" href="/"><span>✦</span><b>SHAZAN AI</b><em>WORKFLOW STUDIO</em></Link>
