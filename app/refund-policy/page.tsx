...
export default function RefundPolicyPage() { return <LegalPage label="REFUND POLICY" title="No surprise billing." summary="The current Mock-only public beta does not accept payments. New accounts receive 500 non-transferable Demo credits with no cash value." sections={[
  { title: "Current beta", paragraphs: ["Stripe, paid provider execution and credit purchases are server-disabled. Because no money is accepted, there is currently no paid purchase to refund. Demo credits cannot be redeemed, transferred or exchanged for money."] },
