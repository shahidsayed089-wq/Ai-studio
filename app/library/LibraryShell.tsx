  ...
  return (
    <main className="library-shell">
      ...
      <section className="library-hero">
        ...
        <p>{view === "projects" ? "Create, organize, duplicate and share every SHAZAN project." : "Your uploads and generated creations remain private and available after refresh."}</p>
